...
//		
//		InputStream input = c1.getResourceAsStream(imagePath);
...
//		return imageview;
	...
	public void move(KeyEvent e) {
		...
		// Before it moves it calls the checkCollisons method to see if there is any
		// problems moving in that direction
		switch (e.getCode()) {
		case DOWN:
